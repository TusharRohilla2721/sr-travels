...
export default function AboutPreview() {
    ...
    return (
        ...
        /*
         * CHANGE 3: Consistent padding on About cards — matches the
         * WhyChooseUs card text padding (1.6rem / 1.4rem).
         * CHANGE 5: Transition now matches WhyChooseUs exactly:
         *   background 0.4s, border-color 0.4s, transform 0.3s
         *   (no separate box-shadow; lift is achieved by transform only)
         */
        .about-preview-card {
          flex: 0 0 280px;
          height: 300px;
          border-radius: 12px;
          /* CHANGE 3 ↓ consistent padding (was 1.8rem 1.5rem) */
          padding: 1.6rem 1.4rem;
          background: var(--card-bg);
          border: 1px solid var(--border);
          scroll-snap-align: start;
          /* CHANGE 5 ↓ exact same transition as .w-card */
        ...
        /* CHANGE 5: hover lift matches WhyChooseUs (translateY -5px, no shadow) */
        ...
        @media (max-width: 768px) {
          .about-preview-card {
            flex: 0 0 78vw;
            height: 260px;
            /* CHANGE 3 ↓ consistent padding on mobile too */
            padding: 1.4rem 1.3rem;
          }
          #about-preview .about-preview-header {
                ...
                >
                    ...
                    >
                        ...
                        <span style={{ fontSize: '0.88rem', color: 'rgba(255,255,255,0.9)' }}>
                            Explore the interactive timelines ➔
                        </span>
                    </div>
                </div>
            </section>
