...
const GALLERY_DATA = {
  all: [
    ...
    'https://res.cloudinary.com/dzadpggxn/image/upload/q_auto,f_auto,w_800/v1774174699/WhatsApp_Image_2026-03-22_at_3.38.02_PM_1_fupqfv.jpg',
    'https://res.cloudinary.com/dzadpggxn/image/upload/q_auto,f_auto,w_800/v1774174699/WhatsApp_Image_2026-03-22_at_3.38.02_PM_1_fupqfv.jpg',
                ...
                <div className={`gin ${dissolve ? 'gin-dissolve' : 'gin-show'}`} style={{
                  ...
                  {imgs.map((src, ii) => (
                    <img key={ii} src={src} alt="SR Travels Gallery" loading="lazy"
                      // Trick: Loads a high-res 1600px version when clicked for the Lightbox!
